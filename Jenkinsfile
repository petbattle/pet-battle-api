        ...
        stage("Build (Compile App)") {
            ...
            steps {
                ...
                script {
                    ...
                    env.VERSION = sh(returnStdout: true, script: "mvn -s /tmp/settings.xml org.apache.maven.plugins:maven-help-plugin:2.1.1:evaluate -Dexpression=project.version").trim()
